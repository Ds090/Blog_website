...
function AddBlog({ handleAddBlog, handleClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-0 flex justify-center items-center addAnimation">
      <form className="w-[450px] h-[500px] flex flex-col justify-center items-center p-1 bg-[#F4F6FE] gap-2 rounded-xl m-8">
        ...
        <input
          ...
          className="border w-[400px] py-1 px-1 font-semibold text-[16px]"
          value={post}
          onChange={(e) => {
        ...
        ></textarea>
        <button
          className="bg-[#6F11F5] w-[400px] py-1 rounded-md text-white font-semibold hover:bg-purple-700 hover:transition hover:duration-500 hover:ease-in-out hover:delay-150"
          onClick={setBlogPost}
        >
          Add Blog
        </button>
